const Footer = () => {
  return (
    <div className="footer flex items-center flex-col bg-slate-100 dark:bg-slate-900 dark:text-white pt-8 md:pt-8 pb-6 md:pb-8 text-center mt-16">
      ...
      <h1 className="text-base md:text-l px-4 md:px-0">
        ...
        &nbsp;to showcase his skills on React, Redux, TypeScript, JS & Web
